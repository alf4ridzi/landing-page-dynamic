...
export default function CTA({ website }) {
  return (
    <section id="contact" className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-brand-60 via-blue-700 to-brand-30"></div>
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-10 left-10 w-72 h-72 bg-white rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-10 right-10 w-96 h-96 bg-purple-400 rounded-full blur-3xl animate-pulse"
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16 pt-12 border-t border-white/20">
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">
                Projects delivered in 2-6 weeks
              </p>
            </div>
