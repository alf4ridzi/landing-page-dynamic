...
import { faCode, faDatabase, faShoppingCart, faRocket, faBolt, faShieldAlt } from "@fortawesome/free-solid-svg-icons";
...
const benefits = [
  { icon: faRocket, text: "Launch in weeks, not months" },
  { icon: faBolt, text: "Lightning-fast performance" },
  { icon: faShieldAlt, text: "Enterprise-grade security" },
];

export default function Solution() {
  return (
    <section id="solutions" className="py-20 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-brand-10 rounded-full blur-3xl opacity-10"></div>
      
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-block px-4 py-2 bg-brand-60/10 text-brand-60 rounded-full text-sm font-semibold mb-4">
            Our Services
          </span>
          ...
          <p className="text-xl text-gray-600">
            From MVPs to enterprise portals – we cover the full product lifecycle.
          </p>
        </div>
          ...
          {services.map((s) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`w-16 h-16 bg-gradient-to-br ${s.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <a href="#contact" className="text-brand-60 font-semibold group-hover:gap-3 flex items-center gap-2 transition-all">
                    Learn more 
        ...
        <div className="bg-gradient-to-r from-brand-60 to-brand-30 rounded-2xl p-8 shadow-xl">
