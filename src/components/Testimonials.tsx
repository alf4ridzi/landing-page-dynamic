          ...
          {items.map((t) => (
            ...
            >
              ...
              <footer className="flex items-center gap-4 pt-6 border-t border-gray-100">
                <div className="w-14 h-14 bg-linear-to-br from-brand-60 to-brand-30 rounded-full flex items-center justify-center text-brand-60 font-bold text-lg shadow-lg border-2 border-blue-600/50">
                  {t.name.charAt(0)}
                </div>
                <div>
                ...
                <div className="ml-auto">
                  <span className="px-3 py-1 bg-brand-60 text-white rounded-full text-xs font-medium">
                    {t.company}
                  </span>
                </div>
              </footer>
